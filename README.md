...
### _Precision AI Tutor for Sri Lanka G.C.E. A/L Biology_
...
> _"As an A/L Biology student preparing for Unit 2 exams, I want instant, accurate answers that match the exact NIE Resource Book definitions so that I can write full-mark answers in my A/L examination."_

### 👩‍🏫 Secondary Persona: A/L Biology Educator / Tutor

> _"As a Biology teacher, I want an instant citation tool that references precise page numbers from NIE resource books and past paper marking schemes so that I can quickly verify student answers during revision sessions."_
...
- ⚡ **Revision Prompt Starter Chips**: Quick one-click prompt starters for core topics (_Properties of Water_, _Enzyme Kinetics & Inhibition_, _Protein Structure_).
...
| **PDF Extraction & OCR** | `PyMuPDF` / `pdfplumber` / `PyTesseract`                                                                                                       | $0-cost local text extraction & OCR engine with Gemini Vision fallback |
